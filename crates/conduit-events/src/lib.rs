...
pub use selectors::{
    ...
    validate_selector_type, validate_top_level_sample_key_fields, validate_wire_selector_value,
    CompiledSelector, PercentKey, SampleKey, SelectorCompileCtx, SelectorMatchCtx,
    NON_RULE_SELECTOR_TYPES, SAMPLE_KEY_FROM_QNAME, SAMPLE_KEY_FROM_RULE_NAME,
    SAMPLE_KEY_FROM_SINK_NAME, SELECTOR_TYPES,
};
