...
Released **2026-07-26** with DNS Conduit **1.2.0**.
...
[All changes in this release](https://github.com/egon1024/DNSConduit/releases/tag/1.2.0) (automated pull request list).
