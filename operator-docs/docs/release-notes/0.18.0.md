...
Released **2026-07-04** with DNS Conduit **0.18.0**.
...
[All changes in this release](https://github.com/egon1024/DNSConduit/releases/tag/0.18.0) (automated pull request list).
