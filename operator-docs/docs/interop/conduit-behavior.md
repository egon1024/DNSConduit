...
| [`health-drain-avoids-backend`](/interop/cases/health-drain-avoids-backend.md) | <span class="interop-outcome interop-outcome--skip">skip</span> | <span class="interop-outcome interop-outcome--pass">pass</span> | <span class="interop-outcome interop-outcome--skip">skip</span> |
| [`health-drain-resume-returns`](/interop/cases/health-drain-resume-returns.md) | <span class="interop-outcome interop-outcome--skip">skip</span> | <span class="interop-outcome interop-outcome--pass">pass</span> | <span class="interop-outcome interop-outcome--skip">skip</span> |
...
| [`health-passive-fast-trip`](/interop/cases/health-passive-fast-trip.md) | <span class="interop-outcome interop-outcome--skip">skip</span> | <span class="interop-outcome interop-outcome--pass">pass</span> | <span class="interop-outcome interop-outcome--skip">skip</span> |
