...
4. [gRPC and conduitctl](/control-plane/grpc-and-conduitctl.md) — **how** to connect, authenticate, and run each CLI command or RPC (`apply`, `export`, `reload`, `trace`, **`health`**, …)
